...
class WorkspaceButton(QPushButton):
    def __init__(self, workspace_index: int, parent_widget: 'WorkspaceWidget', label: str = None,
                 active_label: str = None, populated_label: str = None, animation: bool = False):
        super().__init__()
...
class WorkspaceWidget(BaseWidget):
    ...
    def __init__(
        ...
        self._workspace_container_layout.setContentsMargins(self._padding['left'], self._padding['top'],
    ...
    def _try_add_workspace_button(self, workspace_index: int) -> WorkspaceButton:
        ...
        if workspace_index not in workspace_button_indexes:
            ...
            workspace_btn = WorkspaceButton(workspace_index, self, default_label, active_label, populated_label,
                                            self._animation)
